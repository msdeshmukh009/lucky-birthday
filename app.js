...
const outputPass='<div>Hurray!!You are a lucky person!</div><img width="100%" height="200px"  src="img/undraw_awesome_rlvy.svg" alt="image">'
const outputFail='<div>Ohh!!Your birthday is not that lucky!</div><img width="100%" height="200px"  src="img/undraw_Raining_re_4b55.svg" alt="image">'
